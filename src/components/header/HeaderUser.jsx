  ...
  <div className="container flex items-center justify-between mx-auto text-blue-gray-900">
    <a href="#"
      className="mr-4 block cursor-pointer py-1.5 font-sans text-base font-medium leading-relaxed text-inherit antialiased">
       <img src={imageA} alt="Logo" className=" cursor-pointer" onClick={gotToHome} />
    </a>
    ...
    <div className="flex items-center gap-x-1">
      <button
        ...
        type="button">
        <span className=" cursor-pointer" onClick={goToLogIn} >Log In</span>
      ...
      <button
        ...
        type="button">
        <span className=" cursor-pointer" onClick={goToSignIn}>Sign in</span>
...
/* <nav className="block w-full max-w-screen-xl px-4 py-2 mx-auto text-blue-gray-900 bg-white border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
<div className="container flex items-center justify-between mx-auto">
    <a href="#" className="flex items-center space-x-2">
        <img src={imageA} alt="Logo" className="h-8" />
        <span className="text-lg font-semibold">Menu Semanal</span>
    </a>
    <div className="hidden lg:flex lg:items-center lg:space-x-6">
        <div className="relative">
            ...
            />
            <img src={Glass} alt="Search" className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5" />
        </div>
        <img src={Home} alt="Home" className="h-8 w-8 cursor-pointer" onClick={gotToHome} />
        {isAuthenticated ? (
            <>
            ...
            <img src={Avatar} alt="Sign In" className="h-8 w-8 cursor-pointer" onClick={goToSignIn} />
        )}
    </div>
