...
function HeaderUser() {
  console.log("HeaderUser rendered");
    ...
    return(
<nav
  className="z-50 block w-full max-w-screen-xl px-4 py-2 mx-auto text-white bg-white border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4 mb-10">
    ...
    <div className="hidden lg:block">
      <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        <li
          ...
          <a href="#" className="flex items-center" onClick={goToProgram}>
            Menu Semanal
          </a>
        </li>
        <li
          ...
          <a href="#" className="flex items-center"onClick={goToMeal}>
            Comidas
          </a>
        </li>
        <li
