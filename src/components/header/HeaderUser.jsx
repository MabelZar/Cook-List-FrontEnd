...
function HeaderUser() {
  ...
  return (
    <nav className="z-50 block w-full max-w-screen-xl px-4 py-2 mx-auto text-white bg-white border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4 mb-10">
      <div className="container flex items-center justify-between mx-auto text-blue-gray-900">
        ...
        <div className="flex items-center gap-x-1">
          ...
          <button
            ...
            type="button"
          >
            <span className=" cursor-pointer" onClick={goToSignIn}>
              Sign in
            </span>
          </button>
          <img
