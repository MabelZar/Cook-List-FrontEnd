...
const CreateEditForm = ({ url, method, headerText}) => {
    ...
    const { refreshDestinations } = useContext(MealContext);
    ...
    return (
        <>
        <Card className="w-[20.943rem] h-[31.813rem] my-[5rem] border-[color:var(--col-yellow-light)] border-4 border-solid flex flex-col items-center justify-center" headerText={headerText}>
